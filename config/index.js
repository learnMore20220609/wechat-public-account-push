export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wxcab41aa12efa7f2b",

  // 公众号APP_SECRET
  APP_SECRET: "73bd0b454f1b546256d4e256664bd47a",
  ...
  USERS: [
    {
      ...
      name: "婧婧",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "ofeVX68_zwjed_dPw90LiY8Xg3wE",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "DLjQrkO-rhp6Jj_FPNYJVVK3DGidMzok146FDNGKfCg",
      // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
      openUrl: "https://weibo.com/newlogin?tabtype=weibo&gid=102803&openLoginLayer=0&url=https%3A%2F%2Fweibo.com%2F"
    }, 
  ],
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "ofeVX61A3WuzO-CqNTwU2JuCZ6Js",
    }, 
  ],
